                ...
                <table class="border border-1 border-black w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="border border-1 border-black">KODE PEMBELIAN</th>
                            <th class="border border-1 border-black">TANGGAL</th>
                            <th class="border border-1 border-black">SUPPLIER</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $d)    
                            <tr>
                                ...
                                <td class="border border-1 border-black text-left pl-2">{{ $d->kode_pembelian }}</td>
                                <td class="border border-1 border-black text-left pl-2">{{ $d->tgl_pembelian }}</td>
                                <td class="border border-1 border-black text-left pl-2">{{ $d->supplier->nama_supplier }}</td>
                                <td class="border border-1 border-black text-left pl-2">{{ $d->total_bayar }}</td>
                            </tr>
                        @endforeach    
                    </tbody>
                </table>
